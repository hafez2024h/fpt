...
<body>
    ...
    <script>
        const questions = [
            ...
            { "question": "عندما تواجه صعوبة في العمل، ماذا تفعل؟", "options": ["أبحث عن طريقة جديدة لحل المشكلة.", "أطلب مساعدة من الآخرين.", "أؤجل العمل إلى وقت لاحق.", "أترك المشكلة وأبحث عن شيء آخر."], "points": [40, 30, 10, 20] },
